...
# fwrite(df_fr[is.na(df_fr$retweeted_id),], '/home/rodrigo/Desktop/ChatGPT Data/NLP - French/non_rt_french_unique_id.csv')
...
fwrite(final_en[is.na(final_en$retweeted_id),], 'english_unique_bio_and_text_only.csv', row.names = F)
